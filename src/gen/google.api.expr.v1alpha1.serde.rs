...
impl serde::Serialize for EnumValue {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.EnumValue", len)?;
        if !self.r#type.is_empty() {
...
impl<'de> serde::Deserialize<'de> for EnumValue {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.EnumValue")
            }
        ...
        deserializer.deserialize_struct("google.api.expr.v1alpha1.EnumValue", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ErrorSet {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.ErrorSet", len)?;
        if !self.errors.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ErrorSet {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.ErrorSet")
            }
        ...
        deserializer.deserialize_struct("google.api.expr.v1alpha1.ErrorSet", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EvalState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.EvalState", len)?;
        if !self.values.is_empty() {
...
impl<'de> serde::Deserialize<'de> for EvalState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.EvalState")
            }
        ...
        deserializer.deserialize_struct("google.api.expr.v1alpha1.EvalState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for eval_state::Result {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.EvalState.Result", len)?;
        if self.expr != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("expr", ToString::to_string(&self.expr).as_str())?;
        }
        if self.value != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for eval_state::Result {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.EvalState.Result")
            }
        ...
        deserializer.deserialize_struct("google.api.expr.v1alpha1.EvalState.Result", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Explain {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if !self.expr_steps.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.Explain", len)?;
        if !self.values.is_empty() {
            struct_ser.serialize_field("values", &self.values)?;
        }
        if !self.expr_steps.is_empty() {
            struct_ser.serialize_field("exprSteps", &self.expr_steps)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Explain {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "values" => Ok(GeneratedField::Values),
                            "exprSteps" | "expr_steps" => Ok(GeneratedField::ExprSteps),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.Explain")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<Explain, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut values__ = None;
                let mut expr_steps__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Values => {
                            if values__.is_some() {
                        ...
                        GeneratedField::ExprSteps => {
                            if expr_steps__.is_some() {
                                return Err(serde::de::Error::duplicate_field("exprSteps"));
                            }
                            expr_steps__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(Explain {
                    values: values__.unwrap_or_default(),
                    expr_steps: expr_steps__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("google.api.expr.v1alpha1.Explain", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for explain::ExprStep {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.Explain.ExprStep", len)?;
        if self.id != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
        ...
        if self.value_index != 0 {
            struct_ser.serialize_field("valueIndex", &self.value_index)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for explain::ExprStep {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = explain::ExprStep;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.Explain.ExprStep")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<explain::ExprStep, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut id__ = None;
        ...
        deserializer.deserialize_struct("google.api.expr.v1alpha1.Explain.ExprStep", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for expr::Comprehension {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.iter_var2.is_empty() {
            struct_ser.serialize_field("iterVar2", &self.iter_var2)?;
        }
...
impl serde::Serialize for ExprValue {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.ExprValue", len)?;
...
impl<'de> serde::Deserialize<'de> for ExprValue {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.ExprValue")
            }
...
;
        ...
        deserializer.deserialize_struct("google.api.expr.v1alpha1.ExprValue", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListValue {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.ListValue", len)?;
        if !self.values.is_empty() {
            struct_ser.serialize_field("values", &self.values)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ListValue {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.ListValue")
            }
        ...
        deserializer.deserialize_struct("google.api.expr.v1alpha1.ListValue", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MapValue {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.MapValue", len)?;
        if !self.entries.is_empty() {
            struct_ser.serialize_field("entries", &self.entries)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for MapValue {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.MapValue")
            }
        ...
        deserializer.deserialize_struct("google.api.expr.v1alpha1.MapValue", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for map_value::Entry {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.MapValue.Entry", len)?;
...
impl<'de> serde::Deserialize<'de> for map_value::Entry {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.MapValue.Entry")
            }
        ...
        deserializer.deserialize_struct("google.api.expr.v1alpha1.MapValue.Entry", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for source_info::Extension {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.affected_components.is_empty() {
            ...
            struct_ser.serialize_field("affectedComponents", &v)?;
        }
...
impl serde::Serialize for UnknownSet {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.UnknownSet", len)?;
        if !self.exprs.is_empty() {
            struct_ser.serialize_field("exprs", &self.exprs.iter().map(ToString::to_string).collect::<Vec<_>>())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for UnknownSet {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.UnknownSet")
            }
        ...
        deserializer.deserialize_struct("google.api.expr.v1alpha1.UnknownSet", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Value {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("google.api.expr.v1alpha1.Value", len)?;
        if let Some(v) = self.kind.as_ref() {
            match v {
...
impl<'de> serde::Deserialize<'de> for Value {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct google.api.expr.v1alpha1.Value")
            }
...
;
        ...
        deserializer.deserialize_struct("google.api.expr.v1alpha1.Value", FIELDS, GeneratedVisitor)
    }
}
